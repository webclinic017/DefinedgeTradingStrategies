...
def main():
    ...
    for script in scripts:
        ...
        if rs_1p['signal'].iloc[-1] == 'Bullish' and rs_1p['rsi'].iloc[-1] > 50:
        ...
        if eod_analysis.count_documents({'instrument_name': script}) > 0:
            ...
            for stock in stock_analysis:
                ...
                eod_analysis.update_one({'_id': stock['_id']}, {'$set': {'last_brick_1_percent': renko_1p['color'].iloc[-1]}})
            ...
            analysis = {
                ...
                'last_brick_1_percent': renko_1p['color'].iloc[-1],
